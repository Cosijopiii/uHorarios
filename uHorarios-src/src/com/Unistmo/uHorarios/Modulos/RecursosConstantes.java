package com.Unistmo.uHorarios.Modulos;
...
public interface RecursosConstantes {
	...
	/**
	 * Horas de clase en el que el profesor imparte su primera clase
	 */
	public static final String HORA_ENTRADA[]={"8:00 AM","9:00 AM"};
	/**
	 * Carreras que imparte la universidad
	 */
	public static final String CARRERAS [] ={"Lic. Informatica","Lic. Ciencias Empresariales","Lic. Administracion Publica","Lic. Derecho"};
    /**
    ...
    */
    public static int Buscar(String i,String[] t)
	{
    	int p=-1;
