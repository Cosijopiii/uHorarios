...
public class PanelProfesores extends JDialog implements RecursosConstantes{
	...
	public PanelProfesores() {
		...
		JLabel lblHoraentrada = new JLabel("Horario de entrada");
		lblHoraentrada.setForeground(new Color(255, 215, 0));
		lblHoraentrada.setFont(new Font("Dialog", Font.PLAIN, 16));
		
		JComboBox<?> cmbHoraEntrada = new JComboBox();
		cmbHoraEntrada.setModel(new DefaultComboBoxModel(new String[] {"8 AM", "9 AM"}));
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(lblHoraentrada, GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(cmbHoraEntrada, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
									.addGap(302)
										...
										.addGroup(groupLayout.createSequentialGroup()
											.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addGroup(groupLayout.createSequentialGroup()
													...
													.addPreferredGap(ComponentPlacement.RELATED)
													.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
														.addComponent(txtTelefono, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
														.addComponent(txtClave, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)))
												.addGroup(groupLayout.createSequentialGroup()
												...
												.addGroup(groupLayout.createSequentialGroup()
													...
													.addGap(18)
													.addComponent(txtNombre, GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE))
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(btnAgregarFoto)
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
							.addComponent(lblHoraentrada, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
					...
					.addContainerGap())
				.addComponent(scrollPaneProfesores, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
		);
